...
def create_arg_parser():
    """
    Creates and returns the argument parser for the Linear dataset.

    Returns:
        argparse.ArgumentParser: The argument parser for the Linear dataset.
    """
    ...
    parser.add_argument('--dataset_name', type=str, default='linear', help='Dataset name (default: linear)')
